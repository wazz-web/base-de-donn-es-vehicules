...
# ─── Initialisation et Mise à jour Automatique de la BDD ──────────────────────
def initialiser_base_de_donnees():
    ...
    # 2. Remplissage automatique si la base est vide
    cur.execute("SELECT COUNT(*) FROM vehicules;")
    if cur.fetchone()[0] == 0:
        print("🔄 La base de données est vide. Importation du fichier CSV en cours...")
        ...
        if os.path.exists(CSV_FILENAME):
            ...
            with open(CSV_FILENAME, mode="r", encoding="utf-8-sig") as f:
                ...
                for row in reader:
                    ...
                    cur.execute("""
                        ...
                        VALUES (%s, %s, %s, %s, %s) ON CONFLICT (immatriculation) DO NOTHING RETURNING id;
                    """, (
                        immat,
            ...
            print(f"⚠️ Fichier {CSV_FILENAME} introuvable. Pas d'importation initiale.")
